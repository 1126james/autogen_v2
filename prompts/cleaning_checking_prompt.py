...
<instructions>
    ...
    2. Perform the following validation steps for each issue entry:
       ...
       h. **Column Name Exactness:**
          - Check if the column names mentioned in the cleaning plan **exactly match** the actual column names in the dataset's metadata.
...
<validation_rules>
    ...
    9. **Column Name Exactness:**
       - Ensure that the column names in the cleaning plan **exactly match** those in the dataset metadata.
</validation_rules>
